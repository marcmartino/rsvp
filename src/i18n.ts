...
const resources = {
  en: {
    translation: {
      ...
      Red Spring boardwalk platform promptly at 10:30 AM.
      It will last about a half an hour.
      ...
      attendingCount: "Total Attending",
      decliningCount: "Declining",
      familyMemberName: "Full Name of Guest {{number}}",
      childrenAttendingCount: "Children in your party",
      "menuItem.home": "Home",
      "menuItem.faqs": "FAQs",
  ...
  kr: {
    translation: {
      ...
      cancel: "취소하기",
      "rsvpForm.notes": "Notes",
      attendingCount: "참여가능 인원",
      decliningCount: "거절하는 인원",
